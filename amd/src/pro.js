...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var localcourseindexpro = {

        component: 'local_courseindex',
        shortcomponent: 'local_courseindex',
        componentpath: 'local/courseindex',

        init: function() {

            var licensekeyid = '#id_s_' + localcourseindexpro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + localcourseindexpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            if (crc === calculated) {
                ...
                url += '&provider=' + $('#id_s_' + localcourseindexpro.component + '_licenseprovider').val();

                $(licensekeyid + ' + img').remove();
                $(licensekeyid).after(waiticon);

                $.get(url, function(data) {
                    if (data.match(/CHECK OK/)) {
